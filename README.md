...
점수가 **두 개**입니다. 하는 일이 달라서 나눠 두었습니다.

| | 등급 점수 | 실력 점수 |
|---|---|---|
| 방향 | 오르기만 함 (강등 없음) | 오르내림 |
| 쓰는 곳 | 화면에 보이는 성취 — "진사 4급" | 빠른 대전 상대 고르기 |
| 계산 | 순위별 증감, 등급이 높을수록 하위 순위 페널티가 큼 | `순위점 + (평균 상대 점수 − 내 점수)/40`, 대국 수가 쌓일수록 변동 축소 |

- **급수는 내려가고 단은 올라갑니다.** 유생·진사·급제는 각각 9급에서 1급까지 내려가고,
  최고 등급인 장원만 1단에서 9단으로 올라갑니다 (바둑·태권도와 같은 방향).
- 실력 점수는 1500에서 시작하고 처음 5국은 **배치 대국**이라 크게 움직입니다.
- 빠른 대전은 실력 차 **±200**부터 찾기 시작해 1초에 20씩 넓히고, 최대 ±3000에서 멈춥니다.
  대기 화면에 지금 폭이 그대로 보입니다.
- 양쪽이 서로의 폭 안에 들어야 붙입니다 — 화면에 "±200 안에서 찾는 중"이라 해 놓고
  훨씬 센 사람을 앉히지 않습니다.
- 실력이 외진 사람은 큐 앞에 있어도 뒤를 막지 않고, 대신 60초 뒤 봇 충원을 제안받습니다.
